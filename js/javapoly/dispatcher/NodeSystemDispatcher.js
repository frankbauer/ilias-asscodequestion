...
var NodeSystemDispatcher = function (_CommonDispatcher) {
  ...
  function NodeSystemDispatcher(javapoly) {
    ...
    var _this2 = _possibleConstructorReturn(this, (NodeSystemDispatcher.__proto__ || Object.getPrototypeOf(NodeSystemDispatcher)).call(this, javapoly));
  ...
  _createClass(NodeSystemDispatcher, [{
    ...
    value: function unreflect(result) {
      if (!!result && (typeof result === 'undefined' ? 'undefined' : _typeof(result)) === "object" && result.hasOwnProperty("jsObj")) {
